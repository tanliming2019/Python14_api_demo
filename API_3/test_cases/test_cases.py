...
from API_3.common.my_log import ReadLogging
from API_3.common.do_excle import DoExcle
from API_3.common.http_request import HttpRequest
from API_3.common.project_path import case_path
my_log=ReadLogging()
# 读取测试数据
test_data=DoExcle(case_path,'test_case').read_data()
@ddt
class TestCase(unittest.TestCase):
    def setUp(self):#测试之前的准备工作
        self.t=DoExcle(case_path, 'test_case')#写入测试结果的对象
        pass
